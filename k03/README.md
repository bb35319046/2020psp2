...
## ソースコードの説明
l.24~26:格納された数値を平均、分散、捏造する数値の個数として読み取る
l.36~39:捏造された平均0、分散1の数値に読み取った分散をかけて、読み取った平均を足す。この過程を捏造する数値の個数分繰り返す
（実行時には"./k03 170.8 5.43 5"を入力する）
## 入出力結果
...
## 修正履歴
[comment #20200623]
- 自分からの指示やアドバイス等は特にありません。引き続き先生に提出をお願いします。
